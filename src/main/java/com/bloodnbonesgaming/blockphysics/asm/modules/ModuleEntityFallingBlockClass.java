...
public class ModuleEntityFallingBlockClass implements IClassTransformerModule
{
	...
	{
		final MethodVisitor methodVisitor = classNode.visitMethod(Opcodes.ACC_PUBLIC, "func_70046_E", "()Lnet/minecraft/util/AxisAlignedBB;", null, null);
		final RedirectedMethodVisitor rMethodVisitor = new RedirectedMethodVisitor(methodVisitor);
		methodVisitor.visitCode();
		methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
		rMethodVisitor.visitRedirectedFieldInsn(Opcodes.GETFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70121_D", "Lnet/minecraft/util/AxisAlignedBB;", this);
	...
	{
		final MethodVisitor methodVisitor = classNode.visitMethod(Opcodes.ACC_PUBLIC, "func_70091_d", "(DDD)V", null, null);
		final RedirectedMethodVisitor rMethodVisitor = new RedirectedMethodVisitor(methodVisitor);
		methodVisitor.visitCode();
		methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
		rMethodVisitor.visitRedirectedFieldInsn(Opcodes.GETFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70170_p", "Lnet/minecraft/world/World;", this);
		methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
	...
	public void transformInit1(final MethodNode method)
	{
		...
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70156_m", "Z", this));

		//this.setSize(0.996f, 0.996f);
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new LdcInsnNode(new Float("0.996")));
		toInject.add(new LdcInsnNode(new Float("0.996")));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/entity/item/EntityFallingBlock", "func_70105_a", "(FF)V", false, this));

		//this.yOffset = this.height/2.0f;
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70131_O", "F", this));
		toInject.add(new InsnNode(Opcodes.FCONST_2));
		toInject.add(new InsnNode(Opcodes.FDIV));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70129_M", "F", this));

		//this.motionX = 0;
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new InsnNode(Opcodes.DCONST_0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70159_w", "D", this));

		//this.motionY = 0;
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new InsnNode(Opcodes.DCONST_0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70181_x", "D", this));

		//this.motionZ = 0;
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new InsnNode(Opcodes.DCONST_0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70179_y", "D", this));
		...
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new InsnNode(Opcodes.ICONST_1));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70145_X", "Z", this));

		//this.entityCollisionReduction = 0.8F;
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new LdcInsnNode(new Float("0.8")));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/entity/item/EntityFallingBlock", "field_70144_Y", "F", this));
	...
	public void transformWriteEntityToNBT(final MethodNode method)
	{
		...
		toInject.add(new InsnNode(Opcodes.DASTORE));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/entity/item/EntityFallingBlock", "func_70087_a", "([D)Lnet/minecraft/nbt/NBTTagList;", false, this));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74782_a", "(Ljava/lang/String;Lnet/minecraft/nbt/NBTBase;)V", false, this));
		...
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74774_a", "(Ljava/lang/String;B)V", false, this));
	...
	public void transformReadEntityFromNBT(final MethodNode method)
	{
		...
		toInject2.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74764_b", "(Ljava/lang/String;)Z", false, this));
		...
		toInject2.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_150295_c", "(Ljava/lang/String;I)Lnet/minecraft/nbt/NBTTagList;", false, this));
		...
		toInject2.add(new VarInsnNode(Opcodes.ALOAD, 1));
		toInject2.add(new LdcInsnNode("BPData"));
		toInject2.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74771_c", "(Ljava/lang/String;)B", false, this));
	...
	public void transformCanRenderOnFire(final MethodNode method)
	{
		...
		final InsnList toInject = new InsnList();
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/entity/item/EntityFallingBlock", "func_70090_H", "()Z", false, this));
