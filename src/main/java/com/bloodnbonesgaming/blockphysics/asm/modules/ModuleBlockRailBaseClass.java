...
public class ModuleBlockRailBaseClass implements IClassTransformerModule
{
	...
	public byte[] transform(final String name, final String transformedName, final byte[] bytes)
	{
		...
		if (transformedName.equals("net.minecraft.block.BlockRailBase"))
		{
			...
			final MethodNode methodNode = ASMHelper.findMethodNodeOfClass(classNode, !ObfHelper.isObfuscated() ? "onNeighborBlockChange" : "func_149695_a", "(Lnet/minecraft/world/World;IIILnet/minecraft/block/Block;)V");
			if (methodNode != null)
			{
