...
public class ModuleTileEntityPistonClass implements IClassTransformerModule
{
	...
	{
		final AbstractInsnNode target = ASMHelper.find(method.instructions, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", "func_147460_e", "(IIILnet/minecraft/block/Block;)V", false));

		final InsnList toInject = new InsnList();
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145850_b", "Lnet/minecraft/world/World;", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145851_c", "I", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));;
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145848_d", "I", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145849_e", "I", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		...
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145869_a", "Lnet/minecraft/block/Block;", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145850_b", "Lnet/minecraft/world/World;", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145876_i", "I", this));
		...
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 0));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "movingBlockTileEntityData", "Lnet/minecraft/nbt/NBTTagCompound;", this));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/tileentity/TileEntity", "func_145839_a", "(Lnet/minecraft/nbt/NBTTagCompound;)V", false, this));
		...
		toInject.add(new RedirectedFieldInsnNode(Opcodes.GETFIELD, "net/minecraft/tileentity/TileEntityPiston", "field_145849_e", "I", this));
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 1));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", "func_147455_a", "(IIILnet/minecraft/tileentity/TileEntity;)V", false, this));
		toInject.add(label1);
	...
	public void transformReadFromNBT(final MethodNode method)
	{
		...
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 1));
		toInject.add(new LdcInsnNode("BPData"));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74771_c", "(Ljava/lang/String;)B", false, this));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/tileentity/TileEntityPiston", "bpmeta", "I", this));
		toInject.add(label1);
		...
		toInject.add(new VarInsnNode(Opcodes.ALOAD, 1));
		toInject.add(new LdcInsnNode("TileEntityData"));
		toInject.add(new RedirectedMethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", "func_74775_l", "(Ljava/lang/String;)Lnet/minecraft/nbt/NBTTagCompound;", false, this));
		toInject.add(new RedirectedFieldInsnNode(Opcodes.PUTFIELD, "net/minecraft/tileentity/TileEntityPiston", "movingBlockTileEntityData", "Lnet/minecraft/nbt/NBTTagCompound;", this));
		toInject.add(label2);
