...
public abstract class Entity
{
    ...
    {
    	//TODO Change all 0.001D to 0.07D
        int i = MathHelper.floor_double(this.boundingBox.minX + 0.07D);
        int j = MathHelper.floor_double(this.boundingBox.minY + 0.07D);
        int k = MathHelper.floor_double(this.boundingBox.minZ + 0.07D);
        int l = MathHelper.floor_double(this.boundingBox.maxX - 0.07D);
        int i1 = MathHelper.floor_double(this.boundingBox.maxY - 0.07D);
        int j1 = MathHelper.floor_double(this.boundingBox.maxZ - 0.07D);
