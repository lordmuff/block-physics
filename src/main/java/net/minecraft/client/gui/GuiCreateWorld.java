...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        //TODO Add line
        //TODO Ignore for now
        this.field_146345_x = false; //(createClicked)
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        if (p_146284_1_.enabled)
        {
            ...
            else if (p_146284_1_.id == 0)
            {
                ...
                //Replace line may be a bit more complicated, not 100%, shall see in the end
                //this.mc.launchIntegratedServer(this.field_146336_i, this.field_146333_g.getText().trim(), worldsettings);
                //TODO Ignore for now
                //this.mc.displayGuiScreen(new BGui(this.field_146336_i, this.field_146333_g.getText().trim(), worldsettings, true));
            }
