...
public class RenderFallingSand extends Render
{
    ...
    {
        if ( BClient.cancelRender(par1EntityFallingSand) ) return;
        ...
        else if (block != null)
        {
            ...
            BClient.renderBlockSandFalling(sandRenderBlocks, block, world, MathHelper.floor_double(par1EntityFallingSand.posX), MathHelper.floor_double(par1EntityFallingSand.posY), MathHelper.floor_double(par1EntityFallingSand.posZ), par1EntityFallingSand.metadata);
        }
