    ...
    public void clearPistonTileEntity()
    {
        if (this.lastProgress < 1.0F && this.worldObj != null)
        {
            ...
            if (this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord) == Block.pistonMoving.blockID)
            {
                ...
                {
                	TileEntity tile = Block.blocksList[this.storedBlockID].createTileEntity(this.worldObj, this.storedMetadata);
    				tile.readFromNBT(this.movingBlockTileEntityData);
    				this.worldObj.setBlockTileEntity(this.xCoord, this.yCoord, this.zCoord, tile);
                }
            }
        }
    }
