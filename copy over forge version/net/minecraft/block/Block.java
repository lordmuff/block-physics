...
public class Block
{
    ...
    {
    	BlockPhysics.onBlockDestroyedByPlayer(par1World, par2, par3, par4, par5, this.blockID);
    }
    ...
    {
      	BlockPhysics.onEntityCollidedWithBlock(par1World,  par2, par3, par4, this.blockID, par5Entity);
    }
    ...
    {
    	BlockPhysics.onPostBlockPlaced(par1World, par2, par3, par4, this.blockID, par5);
    }
