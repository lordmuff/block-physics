...
public class Chunk
{
    ...
    public int getBlockBPdata(int par1, int par2, int par3)
    {
        ...
        {
            ExtendedBlockStorage extendedblockstorage = this.storageArrays[par2 >> 4];
            return extendedblockstorage != null ? extendedblockstorage.getBlockBPdata(par1, par2 & 15, par3) : 0;
        }
    }
    ...
    public boolean setBlockBPdata(int par1, int par2, int par3, int par4)
    {
        ...
        {
            int i1 = extendedblockstorage.getBlockBPdata(par1, par2 & 15, par3);
            ...
            {
                this.isModified = true;
                extendedblockstorage.setBlockBPdata(par1, par2 & 15, par3, par4);
                return true;
            }
        }
    }
